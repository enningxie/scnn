...
def train():
    train_images_path = '/dataset/train_img'
    train_gt_path = '/dataset/train_gt'
    test_images_path = '/dataset/test_img'
    test_gt_path = '/dataset/test/gt'
    valid_images_path = '../dataset/val_img'
    valid_gt_path = '../dataset/val_gt'
